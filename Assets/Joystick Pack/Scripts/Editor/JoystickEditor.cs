...
{
    private SerializedProperty uiJoystickOff;
    ...
    {
        uiJoystickOff = serializedObject.FindProperty("uiJoystickOff");
    ...
    {
        EditorGUILayout.PropertyField(uiJoystickOff, new GUIContent("UIJoystickOff", "GameObject for display Joystick"));
